    ...
    return  @[
              ...
              @{@"category":@"Bedroom",@"image":@"bedroom",
                @"duas":@[@{
                          ...
                          @{
                              @"dua:arabic" : @"اَللّٰهُمَّ غَارَتِ النُّجُومُ، وَهَدَأَتِ الْعُيُونُ، وَأَنْتَ حَيٌّ قَيُّومٌ، لَا تَأْخُذُكَ سِنَةٌ وَلَا نَوْمٌ، يَا حَيُّ يَا قَيُّومُ، أَهْدِئْ لَيْلِي وَأَنِمْ عَيْنِي",
                          ...
                          @{
                              @"dua:arabic" : @"بِسْمِ اللهِ الَّذِي لآ إِلٰهَ إِلَّا هُوَ",
              ...
              @{@"category":@"Bathroom",@"image":@"bathroom",
                @"duas":@[@{
                          ...
                          @{
                              @"dua:arabic" : @"بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيمِ",
                              @"dua:transliteration" : @"bismillaah",
                              @"dua:translation" : @"In the name of Allah, the Most Merciful, the Most Gracious.",
                              @"dua:arabic2" : @"اَللّٰهُمَّ اغْفِرْ لِي ذَنْبِي وَوَسِّعْ لِي فِي دَارِي وَبَارِكْ لِي فِي رِزْقِي",
                          ...
                          @{
                             @"dua:arabic" : @"أَشْهَدُ أَنْ لآ إِلٰهَ إِلَّا اللهُ وَحْدَهُ لآ شَرِيكَ لَهُ وَأَشْهَدُ أَنَّ مُحَمَّدَاً عَبْدَهُ وَرَسُولَهُ",
              ...
              @{@"category":@"Food",@"image":@"food",
                @"duas":@[@{
                              @"dua:arabic" : @"بِسْمِ اللهِ وَبَرَكَةِ الله",
                          ...
                          @{
                              @"dua:arabic" : @"اَللّٰهمَّ إِنِّي أَسْأَلُكَ بِرَحْمَتِكَ الَّتِي وَسِعَتْ كُلَّ شَيءِِ ، أَنْ تَغْفِرَ لِي",
                              ...
                              @"dua:arabic2" : @"اَللّٰهُمَّ لَكَ صُمْتُ وَعَلَى رِزْقِكَ اَفْطَرْتُ",
                          ...
                          @{
                              @"dua:arabic" : @"اَللّٰهُمَّ أَطْعِمْ مَنْ أَطْعَمَنِي وَاسْقِ مَنْ سَقَانِي",
                          ...
                          @{
                              @"dua:arabic" : @"اَللّٰهُمَّ إِنِّي أَسْأَلُكَ عِلْمَاً نَافِعَاً وَرِزْقَاً وَاسِعَاً وَشِفَاءً مِّنْ كُلِّ دَاءٍ",
                              @"dua:transliteration" : @"Allahuma innī as'aluka 'ilman nāfi-'aw wa rizqaw wāsi-'aw wa shifā'am min kulli dā(in)",
                              @"dua:translation" : @"O Allah, I ask of You, beneficial knowledge, ample provisions, and restoration from every illness (Mustadrak).",
              ...
              @{@"category":@"Family",@"image":@"family",
                @"duas":@[
                          @{
                        @"dua:arabic" : @"اَللّٰهُمَّ إِنِّىْ أُعِيذُهَا بِكَ وَذُرِّيَّتَهَا مِنَ ٱلشَّيْطـٰنِ الرَّجِيمِ",
                       ...
                       @"dua:arabic2" : @"أَللّٰهُمَّ اجْعَلْهُ (هَا) بَرًّا تَقِيًّا, وَ أَنْبِتْهُ (ها) فِي الْأِسْلَامِ نَباتًا حَسَنًا",
                        ...
                        @{
                            @"dua:arabic" : @"رَبِّ لَا تَذَرْنِى فَرْدً۬ا وَّأَنْتَ خَيۡرُ الْوَارِثِينَ",
              ...
              @{@"category":@"Social",@"image":@"social",
                @"duas":@[@{
                          ...
                          @{
                              @"dua:arabic" : @"أَضْحَكَ اللهُ سِنَّكَ",
              ...
              @{@"category":@"Travel",@"image":@"travel",
                @"duas":@[
                        ...
                        @{
                            @"dua:arabic" : @"اَللّٰهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ الْمَوْلِجِ وَخَيْرَ الْمَخْرَجِ بِسْمِ اللهِ وَلَجْنَا، وَ بِسْمِ اللهِ خَرَجْنَا، وَعَلَى رَبِّنَا تَوَكَّلْنَا",
                        ...
                        @{
                            @"dua:arabic" : @"أَسْتَودِعُ اللهُ دِينَكَ وَ أمَانَتَكَ وَ خَوَاتِيمَ عَمَلِك",
              ...
              @{@"category":@"Marriage",@"image":@"marriage",
                @"duas":@[@{
                          ...
                          @{
                              @"dua:arabic" : @"بِسْمِ اللهِ اَللّٰهُمَّ جَنِّبْنا اَلشَّيْطَانَ وَ جَنِّبِ الشَّيْطَانَ مَا رَزَقْتَنا",
              ...
              @{@"category":@"Health",@"image":@"health",
                @"duas":@[@{
                              @"dua:arabic" : @"أعُوْذُ بِعِزَّةِ اللهِ وَ قُدْرَتِهِ مِنْ شَرِّ ما أَجِدُ أُحَاذِرُ",
                          ...
                          @{
                              @"dua:arabic" : @"اَللّٰهُمَّ رَبِّ النَّاسِّ, أَذْهِبِ الْبَأْسَ, وَ اشْفِ اَنْتَ الشَّافِي ، لَا شِفَاءً اِلَّا شِفَاؤُك, شِفَاءً لَّا يُغَادِرُ سَقَمًا",
                          ...
                          @{
                              ...
                              @"dua:translation" : @"No need to worry. It [this illness] is purging [of sins], Allah willing (Bukhari).",
              ...
              @{@"category":@"Difficulty",@"image":@"difficulty",
                @"duas":@[
                        @{
                            @"dua:arabic" : @"اَللّٰهُمَّ إِنَّا نَجْعَلُكَ فِي نُحُورِهِمْ وَنَعُوذُ بِكَ مِنْ شُرُورِهِمْ",
                        ...
                        @{
                            @"dua:arabic" : @"حَسْبُنَا اللهُ وَنِعْمَ الْوَكِيلُ",
                        ...
                        @{
                            @"dua:arabic" : @"لَا إلٰهَ إِلَّا اللهُ الْعَظِـيمُ الْحَلِـيمْ، لَا إِلٰهَ إِلَّا اللهُ رَبُّ العَـرْشِ العَظِيـمِ، لَا إِلٰـهَ إِلَّا اللهْ رَبُّ السَّمَـوَاتِ وَرَبُّ الأَرْضِ وَرَبُّ العَرْشِ الكَـرِيم",
                        ...
                        @{
                            @"dua:arabic" : @"اَلْحَمْدُ لِلهِ الَّذِي عَافَانِي مِمَّا ابْتَلَاكَ بِهِ وَفَضَّلَنِي عَلَى كَثِيرٍ مِّمَّنْ خَلَقَ تَفْضِيْلَاً",
                        ...
                        @{
                            @"dua:arabic" : @"اَلْحَمْدُ لِلهِ عَلَى كُلِّ حَالٍ",
...
//                              @"searchKeys":@""},
                          @{
                              @"dua:arabic" : @"اَللّٰهُـمَّ اغْفِـرْ لِحَيِّـنَا وَمَيِّتِـنَا وَشَـاهِدِنَا ، وَغَائِبِـنَا ، وَصَغِيْـرِنَا وَكَبِيْـرِنَا ، وَذَكَـرِنَا وَأُنْثَـانَا. اَللّٰهُـمَّ مَنْ أَحْيَيْـتَهُ مِنَّا فَأَحْيِـهِ عَلَى الْإِسْلَامِ ،وَمَنْ تَوَفَّـيْتَهُ مِنَّا فَتَوَفَّـهُ عَلىَ الْإِيْـمَانِ",
              ...
              @{@"category":@"Miscellaneous",@"image":@"miscellaneous",
                @"duas":@[@{
                              @"dua:arabic" : @"بِسْمِ اللهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ",
                          ...
                          @{
                              @"dua:arabic" : @"اَلْحَمْدُ لِلهِ الَّذِيْ بِنِعْمَتِهِ تَتِمُّ الصَّالِحَاتُ",
                          ...
                          @{
                              @"dua:arabic" : @"أَعُوذُ بِاللهِ مِنَ الشَّيْطَانِ الرَّجِيمِ",
